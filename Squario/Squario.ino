...
void TitleScreen() {
  ...
  while (true) {
    ...
    display.setCursor(48,29); display.print(F("Deluxe"));
    display.setCursor(80,48); display.print(F("Compiled"));
    display.setCursor(80,56); display.print(F("13/11/18"));
...
void loop() {
  ...
  while ( Game.Event ) { // 0 is Off
    ...
    if ( currTime > prevTime + FPSDELAY ) {
      ...
      display.setCursor(0,0); display.print(F("Lives: ")); display.print(Game.Lives);
      display.setCursor(0,8); display.print(F("Coins: ")); display.print(Game.Coins);
      display.setCursor(0,16); display.print(F("Level: ")); display.print(Game.MapNumber);
      display.display();
    }
  }
